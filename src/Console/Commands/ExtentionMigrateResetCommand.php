...
class ExtentionMigrateResetCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'extention:migrate:reset';
     ...
     * @var string
     */
    protected $description = 'Rollback all database migrations for a specific or all Extentions';
     ...
     */
    public function __construct(Extentions $extention, Filesystem $files, Migrator $migrator)
    {
        parent::__construct();
    ...
    protected function getMigrationPaths(){
        ...
        foreach ($this->getSlugsToReset() as $slug) {
            ...
            event($slug.'.module.reset', [$this->extention, $this->option()]);
        }
    ...
    protected function getSlugsToReset()
    {
        ...
        if ($this->option("force")) {
            return $this->extention->all()->pluck("slug");
        }

        return $this->extention->enabled()->pluck("slug");
    }
    ...
    protected function validSlugProvided()
    {
        ...
        if ($this->extention->isEnabled($this->argument("slug"))) {
            return true;
        }
