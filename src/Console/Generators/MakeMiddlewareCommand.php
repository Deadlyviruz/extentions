...
class MakeMiddlewareCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'make:extention:middleware
     ...
     * @var string
     */
    protected $description = 'Create a new extention middleware class';
     ...
     * @var string
     */
    protected $type = 'Extention middleware';
    ...
    {
        return extention_class($this->argument('slug'), 'Http\\Middleware');
    }
}
